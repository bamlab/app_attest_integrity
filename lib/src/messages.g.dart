...
class AppAttestIntegrityApi {
  ...
  Future<String?> getPlatformVersion() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.app_attest_integrity.AppAttestIntegrityApi.getPlatformVersion$pigeonVar_messageChannelSuffix';
